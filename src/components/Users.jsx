...
const Users = () => {
  return (
    <div data-aos="fade-down" data-aos-delay="900"  className='flex flex-col justify-center items-center space-x-5 space-y-2 lg:flex-row lg:space-y-0 lg:justify-start'>
